...
Here, the arguments qi, qo, al, ei, eo and im refer to  $q_{\mathrm{in}} = m_2 / m_1 \leq 1$ ,  $q_{\mathrm{out}} = m3 / (m1+m2)$ ,   ,  $e_{\mathrm{in}} $ ,  $e_{\mathrm{out}}$  and  $i_{\mathrm{mut}}$  respectively.
